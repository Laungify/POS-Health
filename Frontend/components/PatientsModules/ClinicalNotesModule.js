...
function PrescriptionsList({
  ...
  const checkIfSubTableOpen = item => !!(item === subTableOpen)
      ...
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            ...
            <TableCell>TreatmentPlan</TableCell>
...
export default function ClinicalNotesModule({
  shopId,
  prescriptions,
  setPrescriptions,
}) {
